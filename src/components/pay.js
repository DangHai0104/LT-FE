                                                ...
                                                <div class="d-flex flex-row pb-3">
                                                    ...
                                                    <div class="rounded border w-100 p-3">
                                                        <p class="d-flex align-items-center mb-0">
                                                            <i class="fab fa-cc-mastercard fa-2x text-dark pe-2"></i>COD
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-row pb-3">
                                                ...
                                                <div class="col-12 col-xl-6">
                                                    <div class="form-outline mb-4 mb-xl-5">
                                                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17"
                                                            placeholder="1111 222 333" minlength="19" maxlength="19" />
                                                        <label class="form-label" for="typeText">Phone Number</label>
                                                    </div>

                                                    <div class="form-outline mb-4 mb-xl-5">
                                                        <input type="text" id="typeD" class="form-control form-control-lg" siez="17"
                                                            placeholder="TPHCM" />
